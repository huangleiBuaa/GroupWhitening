...
class _config:
    norm = 'BN'
    norm_cfg = {}
    norm_methods = {'No': _IdentityModule, 'BN': _BatchNorm, 'GN': _GroupNorm, 'LN': _LayerNorm, 'IN': _InstanceNorm, 'None': None, 'DBN': DBN, 'ItN': IterNorm, 'DBNSigma': DBNSigma, 'ItNSigma': IterNormSigma, 'IGWItN': GroupItN, 'IGWSVD':GroupSVD}
